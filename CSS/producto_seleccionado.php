...
<div class="navbar">
    ...
    <header>
        ...
        <li style="padding-left: 8px;"><a href="./sections.php"> Secciones</a> > </li>
        <li style="padding-left: 8px;"><a href="./productos.php"> Productos</a> > </li>
        <li style="padding-left: 8px;"><a href="./producto_seleccionado.php"> Datos del Producto</a> > </li>
    </header>
    <main>
                ...
                <aside class="right-column">
                    ...
                    <div class="product-block">
                        ...
                        <div class="precio-reserva">
                            ...
                            <button id="openPopup">Reservar Producto</button>
                            ...
                            <div id="popup" class="popup">
                                <div class="popup-content">
                                    ...
                                    <p id="productName">Nombre del Producto: <strong>Producto Ejemplo</strong></p>
                                    <form id="reservationForm">
                                        <label for="email">Gmail:</label>
                                        <input type="email" id="email" name="email" placeholder="Ingrese su Gmail" required>
