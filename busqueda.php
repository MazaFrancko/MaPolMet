...
<body>
    ...
    <header>
        ...
        <li style="padding: 8px;"><a href="./busqueda.php"> Buscar Producto</a></li>
    </header>
    <section class="contenedor-busqueda">
        ...
        if (isset($_SESSION['resultados'])) {
            ...
            foreach ($_SESSION['resultados'] as $producto) {
                echo '<a href="./producto_seleccionado.php?nombre_producto=' . urlencode($producto['nombre_producto']) . '" class="producto">';
